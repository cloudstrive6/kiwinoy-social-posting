...
def _hook_and_caption(observation: str, game: str, gname: str, taglish: bool,
    ...
    prompt = (
        ...
        "Never invent an object, prop, weapon, action, or event that isn't on screen just to "
        "bait a click (e.g. don't ask 'why is Spider-Man pulling out a gun?' when there is no "
        "gun — and heroes like Spider-Man don't use guns anyway). Bait the REAL payoff, hard.\n"
