...
SPIDER_MAN: list[dict[str, str]] = [
    ...
    {"line": "It's the choices that make us who we are.",
     "author": "Peter Parker", "source": "Spider-Man 3"},
    {"line": "This is my gift. This is my curse.",
     "author": "Peter Parker", "source": "Spider-Man"},
    {"line": "You start by doing the hardest thing: you forgive yourself.",
     "author": "Aunt May", "source": "Spider-Man 3"},
    {"line": "I will not die a monster.",
     "author": "Otto Octavius", "source": "Spider-Man 2"},
    {"line": "The hardest thing about this job is you can't always save everybody.",
     "author": "Peter B. Parker", "source": "Into the Spider-Verse"},
    {"line": "Whatever you choose to do with it, you'll be great.",
     "author": "Jefferson Davis", "source": "Into the Spider-Verse"},
    {"line": "Don't let anybody tell you that you don't belong.",
     "author": "Rio Morales", "source": "Across the Spider-Verse"},
    {"line": "I love being Spider-Man.",
