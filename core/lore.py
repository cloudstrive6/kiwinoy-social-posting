...
GAME_LORE["halo"] = (
    ...
    "FIRST-PERSON: Halo is played in FIRST-PERSON — you almost NEVER see the Chief himself; "
    "you see his WEAPON/hands from his POV. So 'no green armor visible' does NOT mean it "
    "isn't the Chief — it's his eyes. Covenant weapons (Needler, plasma pistol/rifle, energy "
    "sword, Brute weapons) look ORGANIC / purple / clawed — an alien-looking gun in the "
    "player's hands is a Covenant weapon the CHIEF is HOLDING, not an enemy or an alien "
    "player-character. The player is Master Chief regardless of which gun he carries.\n"
