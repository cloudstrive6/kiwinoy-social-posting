...
GAME_LORE["wolverine"] = (
    ...
    "NATHANIEL ESSEX — "
    "the man Team X set out to RESCUE and a father figure to Logan & Victor — is revealed "
    "as the TRUE FINAL VILLAIN, MISTER SINISTER: he seizes the HELIX ENGINE to trigger "
    "dormant X-genes worldwide and wipe out non-mutants; the final battle is in TOKYO. "
    "APOCALYPSE (an ancient mutant) is only TEASED late — do NOT call him the final boss.\n"
