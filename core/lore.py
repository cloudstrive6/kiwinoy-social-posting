...
GAME_LORE: dict[str, str] = {
    ...
    "spider-man2": (
        ...
        "TWO-HEROES RULE (CRITICAL): this game stars BOTH Peter AND Miles as a TEAM. Even "
        "when a clip shows only ONE Spider-Man on screen, the other is still part of the "
        "story — so NEVER frame a moment as 'the ONE/ONLY/LONE Spider-Man', 'a single "
        "Spider-Man alone', 'the last hero', or one hero facing a threat by himself. They "
        "fight the big threats (especially the SYMBIOTE INVASION) TOGETHER. Write "
        "\"Spider-Man\" or \"the Spider-Men\" — never imply there is only one.\n"
