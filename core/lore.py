...
GAME_LORE["wolverine"] = (
    ...
    "early; OMEGA RED (a Soviet super-soldier with metal tentacle-coils); LADY DEATHSTRIKE "
    "(adamantium-clawed, tied to the HAND ninja cult); MASTER MOLD (a giant Sentinel-making "
    "machine).\n"
