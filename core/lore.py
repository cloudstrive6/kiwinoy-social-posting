...
GAME_LORE["wolverine"] = (
    ...
    "- CALLISTO: a rescued mutant.\n"
    "ANTAGONISTS: BOLIVAR TRASK + the REAVERS (cyborg mercenaries); MISTER SINISTER / "
    "Essex; OMEGA RED (a Soviet super-soldier with metal tentacle-coils); LADY DEATHSTRIKE "
    "(adamantium-clawed, tied to the HAND ninja cult); and APOCALYPSE (an ancient mutant, "
    "late-game).\n"
