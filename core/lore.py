...
GAME_LORE["wolverine"] = (
    ...
    "machine).\n"
    "KEY TWISTS (so you correctly READ a fight clip): (1) SABRETOOTH begins as a Team X "
    "ally but DIVERGES over Essex's plan and becomes a late RIVAL BOSS — Logan genuinely "
    "FIGHTS him (their duel ends with Sabretooth falling from a cliff). A Logan-vs-"
    "Sabretooth COMBAT clip is a real betrayal fight, NOT a team-up. (2) NATHANIEL ESSEX — "
